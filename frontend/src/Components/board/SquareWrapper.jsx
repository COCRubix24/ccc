...
import { isValidQueenMove, moveQueen } from "../util/QueenObserver";
import { DropTarget } from "react-dnd";
...
class SquareWrapper extends Component {
    render() {
        const { x, y, connectDropTarget, isOver, canDrop, children } =
            this.props;
...
const KnightSquareWrapper = DropTarget(
    ItemTypes.KNIGHT,
    knightTarget,
    collect
)(SquareWrapper);
const QueenSquareWrapper = DropTarget(
    ItemTypes.QUEEN,
    queenTarget,
    collect
)(SquareWrapper);

export { KnightSquareWrapper, QueenSquareWrapper };
